$(document).ready(function() {
  ...
  var hideHidden = function() {
    ...
    if (hidden !== null) {
      ...
      for (var i in pids) {
        ...
        if (el.length) {
          el.hide();
          lnk = window['lnk' + pids[i].replace('post', '')].replace('/', '');
          html += '<li><a style="float:left" target="_blank" href="' + lnk + '">' + decodeURIComponent(lnk) + '</a>' + '<a style="float:right;cursor:pointer" class="show" data-id="#' + pids[i] + '" data-i="' + i + '">x</a></li>';
        }
      }
      if (html === '')
        return;
  ...
  $('#profilePostList').on('click', function(e) {
    ...
    N.html.profile.getHomePostList(0, function(data) {
      ...
      if ($('#profilePostArrow').hasClass('icon-arrow-up-2'))
  ...
  $('#projectPostList').on('click', function(e) {
    ...
    if ($('#projectPostArrow').hasClass('icon-arrow-up-2'))
      $('#projectPostArrow').click();
  ...
  $('#profilePostArrow').click(function() {
    $('#nerdzlist').toggle(400, function() {
      $('#profilePostArrow').toggleClass('icon-arrow-down-2').toggleClass('icon-arrow-up-2');
    });
  });
  $('#projectPostArrow').click(function() {
    $('#projlist').toggle(400, function() {
      $('#projectPostArrow').toggleClass('icon-arrow-down-2').toggleClass('icon-arrow-up-2');
    });
  });

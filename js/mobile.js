...
$(document).ready(function() {
  ...
  var center = function() {
    $('.sidebar').css('height', $('body').innerHeight() - 50);
    $('#notifycounter').parent().css('margin-left', $('#site_title').width() / 2 - 60 - ($('#title_left').length ? 46 : 1) - 25);
  };
